...
<body>
    <div class="content">
      <img src="../images/success.png" alt="" class="404" style='height: auto;
    width: 322px;
    display: block;
    margin: auto;
}'>
<h1 style='display: block;
    text-align: center;'>success.....!</h1>
    <p style='font-size: 1.2em;
            margin-bottom: 20px;text-align: center;'>Return to <a style='color: #3498db;
            text-decoration: none;
            font-weight: bold; 'href="../index.php">home</a> or contact our support team for assistance.</p>
    <div>
<style>
